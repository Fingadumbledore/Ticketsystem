...
//Diese Funktion dient im Moment noch als Plceholder in zukunft soll über diese funktion das zurück gehen möglich sein
int ticketform(){
...
int createTicket(){
    ...
    do
    {
        ...
        else if (Teilnehmer < TicketMaxAnzahl)
        {
